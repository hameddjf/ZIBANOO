...
class Product(models.Model):
    ...
    color = models.CharField(choices=COLOR_CHOICES, blank=False)
    size = models.CharField(choices=SIZE_CHOICES, blank=False)
    ...
    images = models.ForeignKey(ProductGallery, on_delete=models.CASCADE)
